// Verification Key Hash: 65c70330aaa5a9813a6e427c9657105346ebf430c8e995e8ff65f5ba413c933c
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0x65c70330aaa5a9813a6e427c9657105346ebf430c8e995e8ff65f5ba413c933c;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x1f9b0ae2f858d87310999debcbb60ea2ba24aa078f85d38d62633003a0fa666c) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x3051fd09b275272214733e2214a2dd5008e26ee819ccd7105fc09f2d82e3ef90) // vk.Q1.y
            ...
            mstore(add(_vk, 0x1c0), 0x1775429f7820a95aaf53e390ce430b37e29c730d5e13b28f4ef948dbd9e50d32) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x1b22aa1eb9b642305ac7020dfb3fdda68f85cfa0d5d4ab5ad541c95906f3144a) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x1776581e901a025493b58f70ed7e75506f2b1aa4dc8ceaa0d4bb52741405274d) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x1f0d4eb8099578146c777519f3eae2e20de6eabf7b808214182e9ab54c1e1221) // vk.Q_ARITHMETIC.y
            ...
            mstore(add(_vk, 0x300), 0x2415b8eb57e394e079f05d71d893d0599c902cd62c483ad54209d712d8b8519f) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x0c564c892f1154e3d0f2fe00a57ff14fa209ec4724d617701f9c874493541377) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x290771e1602131221cb2c905e591041645e590247f6d7bdc98c79c564c26b916) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x1b76032f305337f750f65b1f62197fa0d3e50a04a6ac2731608d35f724a34a29) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x116e7ac9e36215a01cff38e89015375c7bafa2b5d49bdc7ed9ce57352b4d5205) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x1b30f8a009d6771115b4933362f66cfc63e4afb9b16e97e5b6db7c1bd4e30c75) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x2ce34220edb3701d90d03a58d421fbf14e98ad5fc8e568a57d811d1a94c50fe0) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x23de1c46643edb41ceea4d0124d3603bc20dc51fd10785867a2efcee1e2f13d1) // vk.SIGMA4.y
